...
class CustomPostTypeController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'ninja_plugin_cpt_settings',
				'option_name' => 'ninja_plugin_cpt',
	...
	{
		$options = get_option('ninja_plugin_cpt');
		...
		if($options)
		{
			foreach ($options as $key => $option)
			{
				$this->custom_post_types[] = array(
					...
					'insert_into_item'      => 'Insert in to ' . $option['singular_name'],
	...
	function setSubPages()
	{
		$this->subpages = array(
			array(
				...
				'menu_slug'  => 'ninja_cpt',
				'callback'   => array($this->callbacks, 'ctpDashboard'),
			)
		);
	}
}